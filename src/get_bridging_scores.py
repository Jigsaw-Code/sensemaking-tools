...
def get_bridging_scores(df: pd.DataFrame, text_column: str, api_key: str, scorer_type: str = "GEMINI"):
  """Score df with bridging attributes using specified scorer."""

  if scorer_type == "GEMINI":
    print("Using Gemini for bridging scoring...")
...
if __name__ == "__main__":
  ...
  df = get_bridging_scores(df, args.text_column, args.api_key, args.scorer_type)
